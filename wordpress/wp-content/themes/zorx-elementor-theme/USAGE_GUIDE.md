...
To setup the contact form on the Contact Page:
1.  Install the **Contact Form 7** plugin.
2.  Create a new form.
3.  Open the file `CONTACT_FORM_CODE.md` in your theme folder (or ask for it) and copy the HTML code into the form editor.
4.  Copy the shortcode it gives you.
5.  Paste that shortcode into the "Shortcode" widget on your Contact Page.
